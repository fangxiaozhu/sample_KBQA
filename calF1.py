...
ft = open(config.test_data_path,'r',encoding='utf8')
p = re.compile(r'\s')
...
while True:
    path = config.result_path ##   result_bert_path
    if path == 'exit()':
        exit()
    ...
    F1 = 0
    print('ftList------',len(ftList))
    print('falist----',len(faList))
    ...
    print('Triple F1:\t' + str(F1/ len(ftList)))
    print('ftList---',len(ftList))
